...
<div class="form-container">
    ...
    <div class="status-badge status-<?php echo $produk['status_verifikasi']; ?>" style="margin-bottom: 2rem;">
        Status: <?php echo ucfirst($produk['status_verifikasi']); ?>
    </div>
    ...
    <form class="product-form" method="POST" enctype="multipart/form-data">
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select id="kategori" name="kategori" class="form-select" required>
                    ...
                    <option value="Baju" <?php echo $produk['kategori'] == 'Baju' ? 'selected' : ''; ?>>Baju</option>
                    <option value="Celana" <?php echo $produk['kategori'] == 'Celana' ? 'selected' : ''; ?>>Celana</option>
                    <option value="Rok" <?php echo $produk['kategori'] == 'Rok' ? 'selected' : ''; ?>>Rok</option>
                    <option value="Jaket" <?php echo $produk['kategori'] == 'Jaket' ? 'selected' : ''; ?>>Jaket</option>
                    <option value="Sepatu" <?php echo $produk['kategori'] == 'Sepatu' ? 'selected' : ''; ?>>Sepatu</option>
                    <option value="Tas" <?php echo $produk['kategori'] == 'Tas' ? 'selected' : ''; ?>>Tas</option>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" id="harga" name="harga" class="form-input" min="0"
                       value="<?php echo $produk['harga']; ?>" required>
            </div>

            <div class="form-group">
                <label class="form-label" for="stok">Stok *</label>
                <input type="number" id="stok" name="stok" class="form-input" min="0"
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi" name="deskripsi" class="form-textarea" required><?php echo htmlspecialchars($produk['deskripsi']); ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if ($produk['gambar'] && file_exists("../assets/images/" . $produk['gambar'])): ?>
                <div style="margin-bottom: 1rem;">
                    <img src="../assets/images/<?php echo htmlspecialchars($produk['gambar']); ?>" alt="Current Image" class="current-image">
                    <p style="margin-top: 0.5rem; font-size: 0.9rem; color: var(--text-light);">Gambar saat ini</p>
                </div>
            <?php endif; ?>
            ...
            <div class="file-input-wrapper">
                ...
                <label for="gambar" class="file-input-label">
                    ...
                    <span>Klik untuk mengganti gambar (opsional)</span>
                </label>
            </div>
...
document.getElementById('gambar').addEventListener('change', function(e) {
    ...
    document.getElementById('file-name').textContent = fileName ? 'File baru: ' + fileName : '';
});
</script>
